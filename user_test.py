...
class TestUser(unittest.TestCase):
     ...
     def setUp(self):
          ...
          self.new_user = User("Eid","Abdullahi","Eid","12345")
     ...
     def test_init(self):
          ...
          '''
        self.assertEqual(self.new_user.first_name,"Eid")
        self.assertEqual(self.new_user.last_name,"Abdullahi")
        self.assertEqual(self.new_user.user_name,"Eid")
        self.assertEqual(self.new_user.password,"12345a")
     ...
     def test_save_multiple_user(self):
       ...
       '''
        self.new_user.save_user()
        test_user = User("Facebook","Eid","Eid","12345a") 
        test_user.save_user()
     ...
     def test_find_user_by_username(self):
         ...
         found_user = User.find_by_user_name("Eid")
     ...
     def test_user_exists(self):
         ...
         user_exists = User.user_exist("Eid")
